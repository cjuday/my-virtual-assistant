...
@section('content')
@if(get_hourly(Auth::guard('employee')->id())->hourly_charge==0)
<div class="alert alert-warning">
  <i class="fas fa-info"></i> Update your hourly rate and other conditions from profile settings to get work.
</div>
@endif
                      <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Clients Worked With
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
